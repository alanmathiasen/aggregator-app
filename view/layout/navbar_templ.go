...
func Navbar() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<header class=\"navbar max-w-screen-xl mx-auto\"><div class=\"flex-1\"><a class=\"btn btn-ghost text-xl\">TrackingAPP</a></div><div class=\"flex-none\"><div class=\"menu menu-horizontal\"><ul class=\"menu menu-horizontal px-1\"><li><a href=\"/dashboard\">Dashboard</a></li><li><a href=\"/discover\">Discovery</a></li></ul></div><div class=\"dropdown dropdown-end\"><div tabindex=\"0\" role=\"button\" class=\"btn btn-ghost btn-circle avatar\"><div class=\"w-10 rounded-full\"><img alt=\"Tailwind CSS Navbar component\" src=\"/static/images/default.png\"></div></div><ul tabindex=\"0\" class=\"menu menu-sm dropdown-content mt-3 z-[1] p-2 rounded-box w-52 bg-info\"><li><a class=\"justify-between\">Profile <span class=\"badge\">New</span></a></li><li><a>Settings</a></li><li><form action=\"/auth/logout\" method=\"POST\"><button type=\"submit\">Logout</button></form></li></ul></div></div></header>")
